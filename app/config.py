...
class Settings:
    ...
    bark_red_repeat: int = int(os.getenv("BARK_RED_REPEAT", "1"))
    bark_red_repeat_gap_seconds: float = float(os.getenv("BARK_RED_REPEAT_GAP_SECONDS", "0"))
    bark_yellow_level: str = os.getenv("BARK_YELLOW_LEVEL", "timeSensitive")
    bark_yellow_volume: str = os.getenv("BARK_YELLOW_VOLUME", "4")
    bark_yellow_sound: str = os.getenv("BARK_YELLOW_SOUND", "alarm")
    bark_yellow_repeat: int = int(os.getenv("BARK_YELLOW_REPEAT", "1"))
    bark_yellow_repeat_gap_seconds: float = float(os.getenv("BARK_YELLOW_REPEAT_GAP_SECONDS", "0"))
    bark_blue_level: str = os.getenv("BARK_BLUE_LEVEL", "active")
    bark_blue_volume: str = os.getenv("BARK_BLUE_VOLUME", "")
    bark_blue_sound: str = os.getenv("BARK_BLUE_SOUND", "")
